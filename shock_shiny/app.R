...
input_color_list <- list("observed crop yield" =  "#157567",
                         "nitrogen" = "#326286",
                         "phosphorus" =  "#CF5422",
                         "potassium" =  "#FD6467",
                         "machinery" =  "#5B1A18",
                         ...
                         "fungicides" = "#4E2E74",
                         "insecticides" = "#4E2E74",
                         "other pesticides" = "#4E2E74",
                         "soil carbon" = "#FD6467",
                         "soil phosphorus" = "#CF5422",
                         "soil nitrogen" = "#326286",
                         "nonmineral nitrogen" = "#326286",
                         "nonmineral phosphorus" = "#CF5422",
                         "irrigation" = "#130DD1",
                         "agricultural workers" = "#5B1A18",
                         "modelled baseline yield" = "#157567",
                         "modelled zero input yield" = "#157567"
                         )

input_unit_list <- list("observed crop yield" =  "t/ha",
                        "nitrogen" = "kg/ha",
                        "phosphorus" =  "kg/ha",
                        "potassium" =  "kg/ha",
                        "machinery" =  "1000 metric horsepower (CV)",
                        "herbicides" = "rescaled kg/ha",
                        "fungicides" = "rescaled kg/ha",
                        "insecticides" = "rescaled kg/ha",
                        "other pesticides" = "rescaled kg/ha",
                        "soil carbon" = "t/ha",
                        "soil phosphorus" = "mg/kg",
                        "soil nitrogen" = "t/ha",
                        "nonmineral nitrogen" = "kg/ha",
                        "nonmineral phosphorus" = "kg/ha",
                        "irrigation" = "%",
                        "agricultural workers" = "persons",
                        "modelled baseline yield" = "t/ha",
                        "modelled zero input yield" = "t/ha")
               ...
               fluidRow(
                 ...
                 column(4,
                        ...
                        column(11, 
                               ...
                               we divided each crop into climate zones or bins according to growing degree days (GDD) and precipitation. 
                ...
                column(2,
                    column(12,
                       selectInput("agriinput", "Select data to display",
                                   choices = c("observed crop yield", "nitrogen", 
                                               "phosphorus","potassium", "machinery",
                                               "herbicides", "fungicides", "insecticides", "other pesticides",
                                               "soil carbon", "soil phosphorus", "soil nitrogen", "nonmineral nitrogen",
                                               "nonmineral phosphorus",  "irrigation", "agricultural workers", "modelled baseline yield",
                                               "modelled zero input yield"),
                                   selected = "observed crop yield")))
                        ...
                        column(11,
                             ...
                             selectInput("agri", 
                                         ...
                                         choices = c("nitrogen", 
                                                     ...
                                                     "herbicides", "fungicides", "insecticides", "other pesticides",
                                                     "soil carbon", "soil phosphorus", "soil nitrogen", "nonmineral nitrogen",
                                                     "nonmineral phosphorus",  "irrigation", "agricultural workers"),
                                         selected = "nitrogen"),
        ...
        tabPanel("Performance",
            ...
            column(11,
              ...
              tabsetPanel(
                ...
                #                      choices = c("barley", "groundnut", "maize", "millet", "rice",
                #                                  "potato", "sorghum", "soybean", "sugarbeet", "sugarcane",
                #                                  "wheat"),
                #                      selected = "barley"),
...
server <- function(input, output) {
  ...
  input_map_data <- reactive({
    ...
    get(load(file_name))
    colnames(crop_scenarios) <- c("cell","x", "y", "observed crop yield", "scenario_percent", 
                                  ...
                                  "herbicides", "fungicides", "insecticides", "other pesticides",
                                  "soil carbon", "soil phosphorus", "soil nitrogen", "nonmineral nitrogen",
                                  "nonmineral phosphorus",  "irrigation", "modelled baseline yield",
                                  "modelled zero input yield", "agricultural workers")
  ...
  plot_data <- reactive({
    ...
    get(load(file_name))
    colnames(crop_scenarios) <- c("cell","x", "y", "observed_normal_yield", "scenario_percent", 
                                  "nitrogen shock", "phosphorus shock",
                                  "potassium shock", "machinery shock",
                                  "pesticide shock", "fertilizer shock", 
                                  "shock in all inputs", "bin", "nitrogen", 
